...
SIZE = {
    ...
    "gemma-3-270m": ("gemma-3-270m-it", 0.27),
    "TinyLlama": ("TinyLlama-1.1B", 1.1),
    "LFM2.5-1.2B": ("LFM2.5-1.2B", 1.2),
    "Qwen2.5-3B": ("Qwen2.5-3B", 3.0),
    "Qwen2.5-7B": ("Qwen2.5-7B", 7.0),
    "Qwen2.5-14B": ("Qwen2.5-14B", 14.0),
    "pythia": ("pythia-410m (base)", 0.41),
    "Supra-50M": ("Supra-50M (inst)", 0.05),
    "Qwen2.5-0.5B": ("Qwen2.5-0.5B (base)", 0.5),
}
...
def main():
    ...
    for d in results:
        ...
        print(
            "%-22s %6.2f %11.3f %11.3f %10.3f %9.3f %8.3f  best=%s"
            % (
                d["name"],
                d["params"],
                d["complement"],
