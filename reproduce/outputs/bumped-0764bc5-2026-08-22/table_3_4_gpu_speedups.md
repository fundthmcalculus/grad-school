...
|---|---|---|---|---|---|
| Boruvka MST (device) | N=4,000, float64, matrix resident | 1.0× (worst) | 4.4× | order 1.000 (bit-identical) | estimate (10 seeds) |
| VAT front end | N=4,000, float64, order only | 1.0× (worst) | 2.4× | order 1.000 (bit-identical) | estimate (10 seeds) |
| VAT front end | N=4,000, float64, UNMATCHED work | 1.0× (worst) | 5.5× | order 1.000 (bit-identical) | estimate (10 seeds) |
| Boruvka MST (device) | N=8,000, float64, matrix resident | 1.0× (worst) | 5.2× | order 1.000 (bit-identical) | estimate (10 seeds) |
| VAT front end | N=8,000, float64, order only | 1.0× (worst) | 3.0× | order 1.000 (bit-identical) | estimate (10 seeds) |
| VAT front end | N=8,000, float64, UNMATCHED work | 1.0× (worst) | 7.4× | order 1.000 (bit-identical) | estimate (10 seeds) |
| Boruvka MST (device) | N=16,000, float64, matrix resident | 1.0× (worst) | 4.5× | order 1.000 (bit-identical) | estimate (10 seeds) |
| VAT front end | N=16,000, float64, order only | 1.0× (worst) | 3.1× | order 1.000 (bit-identical) | estimate (10 seeds) |
| VAT front end | N=16,000, float64, UNMATCHED work | 1.0× (worst) | 7.6× | order 1.000 (bit-identical) | estimate (10 seeds) |
| Boruvka MST (device) | N=32,000, float64, matrix resident | 1.0× (worst) | 4.1× | order 1.000 (bit-identical) | estimate (10 seeds) |
| VAT front end | N=32,000, float64, order only | 1.0× (worst) | 3.9× | order 1.000 (bit-identical) | estimate (10 seeds) |
| VAT front end | N=32,000, float64, UNMATCHED work | 1.0× (worst) | 9.7× | order 1.000 (bit-identical) | estimate (10 seeds) |
| Fuzzy C-Means | N=50,000, k=10, d=20 | 1.0× (worst) | 4.2× | labels 1.000 ± 0.001; max abs Δcentre 4.9e-05 | estimate (10 seeds) |
| Fuzzy C-Means | N=50,000, k=10, d=20, MATCHED formulation | 1.0× (worst) | 2.4× | labels 1.000; max abs Δcentre 1.6e-13 | estimate (10 seeds) |
| Fuzzy C-Means | N=200,000, k=10, d=20 | 1.0× (worst) | 5.8× | labels 1.000; max abs Δcentre 4.8e-06 | estimate (10 seeds) |
| Fuzzy C-Means | N=200,000, k=10, d=20, MATCHED formulation | 1.0× (worst) | 3.0× | labels 1.000; max abs Δcentre 3.2e-13 | estimate (10 seeds) |
| Fuzzy C-Means | N=500,000, k=10, d=20 | 1.0× (worst) | 6.7× | labels 1.000; max abs Δcentre 9.8e-06 | estimate (10 seeds) |
| Fuzzy C-Means | N=500,000, k=10, d=20, MATCHED formulation | 1.0× (worst) | 3.5× | labels 1.000; max abs Δcentre 6.0e-13 | estimate (10 seeds) |
| Pairwise distances | N=16,000, d=10, float64, high_precision | 3.4× | 1.0× (worst) | max abs Δ = 7.1e-15 | estimate (10 seeds) |
| Pairwise distances | N=16,000, d=50, float64, high_precision | 3.3× | 1.0× (worst) | max abs Δ = 2.8e-14 | estimate (10 seeds) |
| Pairwise distances | N=16,000, d=200, float64, high_precision | 2.0× | 1.0× (worst) | max abs Δ = 7.1e-14 | estimate (10 seeds) |
| Pairwise distances | N=16,000, d=784, float64, high_precision | 2.8× | 1.0× (worst) | max abs Δ = 2.8e-13 | estimate (10 seeds) |
| Pairwise distances | N=16,000, d=10, float32, high_precision | 3.3× | 1.0× (worst) | max abs Δ = 0.0e+00 | estimate (10 seeds) |
| Pairwise distances | N=16,000, d=10, float32, fast (native acc) | 3.0× | 1.0× (worst) | max abs Δ = 3.8e-06 | estimate (10 seeds) |
| Pairwise distances | N=16,000, d=50, float32, high_precision | 3.4× | 1.0× (worst) | max abs Δ = 1.9e-06 | estimate (10 seeds) |
| Pairwise distances | N=16,000, d=50, float32, fast (native acc) | 2.5× | 1.0× (worst) | max abs Δ = 1.1e-05 | estimate (10 seeds) |
| Pairwise distances | N=16,000, d=200, float32, high_precision | 2.5× | 1.0× (worst) | max abs Δ = 3.8e-06 | estimate (10 seeds) |
| Pairwise distances | N=16,000, d=200, float32, fast (native acc) | 1.3× | 1.0× (worst) | max abs Δ = 3.8e-05 | estimate (10 seeds) |
| Pairwise distances | N=16,000, d=784, float32, high_precision | 1.9× | 1.0× (worst) | max abs Δ = 7.6e-06 | estimate (10 seeds) |
| Pairwise distances | N=16,000, d=784, float32, fast (native acc) | 1.0× (worst) | 1.1× | max abs Δ = 1.4e-04 | estimate (10 seeds) |
| VAT front end | N=48,000, float32, 9.22 GB resident | 1.0× (worst) | 3.2× | order 0.99992; Prim total CPU 42023.180315 vs GPU 42023.180315 (rel 0.00e+00) | demonstration (1 shot) |
