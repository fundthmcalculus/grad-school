...
|---|---|---|---|---|---|
| Boruvka MST (device) | N=4,000, float64, matrix resident | 1.0× (worst) | 3.9× | order 1.000 (bit-identical) | estimate (10 seeds) |
| VAT front end | N=4,000, float64, order only | 1.0× (worst) | 2.2× | order 1.000 (bit-identical) | estimate (10 seeds) |
| VAT front end | N=4,000, float64, UNMATCHED work | 1.0× (worst) | 4.9× | order 1.000 (bit-identical) | estimate (10 seeds) |
| Boruvka MST (device) | N=8,000, float64, matrix resident | 1.0× (worst) | 5.4× | order 1.000 (bit-identical) | estimate (10 seeds) |
| VAT front end | N=8,000, float64, order only | 1.0× (worst) | 2.9× | order 1.000 (bit-identical) | estimate (10 seeds) |
| VAT front end | N=8,000, float64, UNMATCHED work | 1.0× (worst) | 6.9× | order 1.000 (bit-identical) | estimate (10 seeds) |
...
| VAT front end | N=16,000, float64, UNMATCHED work | 1.0× (worst) | 7.5× | order 1.000 (bit-identical) | estimate (10 seeds) |
| Boruvka MST (device) | N=32,000, float64, matrix resident | 1.0× (worst) | 4.1× | order 1.000 (bit-identical) | estimate (10 seeds) |
| VAT front end | N=32,000, float64, order only | 1.0× (worst) | 4.0× | order 1.000 (bit-identical) | estimate (10 seeds) |
| VAT front end | N=32,000, float64, UNMATCHED work | 1.0× (worst) | 9.3× | order 1.000 (bit-identical) | estimate (10 seeds) |
| Fuzzy C-Means | N=50,000, k=10, d=20 | 1.0× (worst) | 3.9× | labels 1.000 ± 0.001; max abs Δcentre 4.9e-05 | estimate (10 seeds) |
...
| Fuzzy C-Means | N=200,000, k=10, d=20 | 1.0× (worst) | 6.1× | labels 1.000; max abs Δcentre 4.8e-06 | estimate (10 seeds) |
...
| Fuzzy C-Means | N=500,000, k=10, d=20 | 1.0× (worst) | 6.8× | labels 1.000; max abs Δcentre 9.8e-06 | estimate (10 seeds) |
...
| Pairwise distances | N=16,000, d=10, float64, high_precision | 3.5× | 1.0× (worst) | max abs Δ = 7.1e-15 | estimate (10 seeds) |
| Pairwise distances | N=16,000, d=50, float64, high_precision | 3.4× | 1.0× (worst) | max abs Δ = 2.8e-14 | estimate (10 seeds) |
...
| Pairwise distances | N=16,000, d=200, float32, high_precision | 2.4× | 1.0× (worst) | max abs Δ = 3.8e-06 | estimate (10 seeds) |
| Pairwise distances | N=16,000, d=200, float32, fast (native acc) | 1.3× | 1.0× (worst) | max abs Δ = 3.8e-05 | estimate (10 seeds) |
| Pairwise distances | N=16,000, d=784, float32, high_precision | 1.8× | 1.0× (worst) | max abs Δ = 7.6e-06 | estimate (10 seeds) |
