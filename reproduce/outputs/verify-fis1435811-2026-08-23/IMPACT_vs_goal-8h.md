# Fix impact — `goal-8h-2026-08-11-fullsuite` → `bumped-0764bc5-2026-08-22`
...
| `table_3_2_memory_precision` | 26 | **2 changed** |
| `table_3_4_gpu_speedups` | 195 | **36 changed**, 32 within noise, 31 timing |
| `table_3_7_g2_downstream` | 7 | 2 rows removed |
| `table_3_7_g2_dtw_nonmetric` | 5 | **1 changed**, 2 rows removed |
| `table_4_1` | 17 | **1 changed**, 3 within noise, 5 timing |
...
| `table_6_1` | 15 | **1 changed**, 4 within noise |
...
| `table_norm_conorm_matrix` | 54 | **22 changed**, 10 within noise |
...
|---|---|---|---|---:|---|
| 1,024 | classical VAT (s) | 19.284 ± 2.685 s | 13.459 ± 0.286 s | -5.8250 | timing |
| 1,024 | pVAT (s) | 0.023 ± 0.002 s | 0.021 ± 0.002 s | -0.0020 | timing |
| 1,024 | speedup | 827x | 632x | -195.0000 | timing |
| 2,048 / infeasible (>cap) | pVAT (s) | 0.079 ± 0.004 s | 0.076 ± 0.008 s | -0.0030 | timing |
| 256 | classical VAT (s) | 0.322 ± 0.053 s | 0.262 ± 0.015 s | -0.0600 | timing |
| 256 | pVAT (s) | 0.439 ± 1.310 s | 0.013 ± 0.031 s | -0.4260 | timing |
| 256 | speedup | 1x | 21x | +20.0000 | timing |
| 4,096 / infeasible (>cap) | pVAT (s) | 0.255 ± 0.006 s | 0.234 ± 0.009 s | -0.0210 | timing |
| 512 | classical VAT (s) | 2.189 ± 0.166 s | 1.796 ± 0.042 s | -0.3930 | timing |
| 512 | pVAT (s) | 0.007 ± 0.001 s | 0.006 ± 0.001 s | -0.0010 | timing |
| 512 | speedup | 329x | 291x | -38.0000 | timing |

### `table_3_1_complexity_fit`

| Row | Column | Before | After | Δ | |
|---|---|---|---|---:|---|
| fitted exponent /  | classical | **3.15** (6 pts) | **3.05** (6 pts) | -0.1000 | **changed** |
| fitted exponent /  | stage 1 | **1.81** (11 pts) | **1.77** (11 pts) | -0.0400 | **changed** |
| fitted exponent /  | stage 2 | **1.89** (11 pts) | **1.73** (11 pts) | -0.1600 | **changed** |
| 1,000 / 10.0× | classical | 1294.66× | 1130.26× | -164.4000 | timing |
| 1,000 / 10.0× | stage 1 | 69.16× | 50.58× | -18.5800 | timing |
| 1,000 / 10.0× | stage 2 | 60.63× | 53.55× | -7.0800 | timing |
| 1,250 / 12.5× / N/A | stage 1 | 105.90× | 78.53× | -27.3700 | timing |
| 1,250 / 12.5× / N/A | stage 2 | 87.90× | 77.15× | -10.7500 | timing |
| 1,500 / 15.0× / N/A | stage 1 | 144.62× | 110.52× | -34.1000 | timing |
| 1,500 / 15.0× / N/A | stage 2 | 134.00× | 107.12× | -26.8800 | timing |
| 2,000 / 20.0× / N/A | stage 1 | 202.42× | 191.27× | -11.1500 | timing |
| 2,000 / 20.0× / N/A | stage 2 | 245.60× | 176.34× | -69.2600 | timing |
| 2,500 / 25.0× / N/A | stage 1 | 314.03× | 293.12× | -20.9100 | timing |
| 2,500 / 25.0× / N/A | stage 2 | 476.30× | 287.42× | -188.8800 | timing |
| 200 / 2.0× | classical | 7.46× | 7.53× | +0.0700 | timing |
| 200 / 2.0× | stage 1 | 3.25× | 3.17× | -0.0800 | timing |
| 200 / 2.0× | stage 2 | 3.18× | 3.62× | +0.4400 | timing |
| 3,000 / 30.0× / N/A | stage 1 | 415.18× | 409.92× | -5.2600 | timing |
| 3,000 / 30.0× / N/A | stage 2 | 640.40× | 410.72× | -229.6800 | timing |
| 300 / 3.0× | classical | 26.10× | 26.21× | +0.1100 | timing |
| 300 / 3.0× | stage 1 | 6.24× | 6.18× | -0.0600 | timing |
| 300 / 3.0× | stage 2 | 6.74× | 7.50× | +0.7600 | timing |
| 500 / 5.0× | classical | 130.50× | 124.93× | -5.5700 | timing |
| 500 / 5.0× | stage 1 | 17.13× | 15.84× | -1.2900 | timing |
| 500 / 5.0× | stage 2 | 20.49× | 19.49× | -1.0000 | timing |
| 750 / 7.5× | classical | 576.37× | 435.47× | -140.9000 | timing |
| 750 / 7.5× | stage 1 | 43.54× | 29.90× | -13.6400 | timing |
| 750 / 7.5× | stage 2 | 40.64× | 38.57× | -2.0700 | timing |

### `table_3_1_three_arm`

| Row | Column | Before | After | Δ | |
|---|---|---|---|---:|---|
| 1,000 | classical O(N³) (s) | 0.1742 ± 0.0029 s | 0.1300 ± 0.0016 s | -0.0442 | timing |
| 1,000 | stage 1 O(N²logN) (s) | 0.0136 ± 0.0009 s | 0.0087 ± 0.0001 s | -0.0049 | timing |
| 1,000 | stage 2 O(N²) (s) | 0.0008 ± 0.0001 s | 0.0010 ± 0.0001 s | +0.0002 | timing |
| 1,000 | cls/s2 | 213.0× | 136.0× | -77.0000 | timing |
| 1,000 | s1/s2 | 16.6× | 9.1× | -7.5000 | timing |
| 1,250 / not run (> cap) | stage 1 O(N²logN) (s) | 0.0208 ± 0.0022 s | 0.0135 ± 0.0005 s | -0.0073 | timing |
| 1,250 / not run (> cap) | stage 2 O(N²) (s) | 0.0012 ± 0.0001 s | 0.0014 ± 0.0002 s | +0.0002 | timing |
| 1,250 / not run (> cap) | s1/s2 | 17.6× | 9.8× | -7.8000 | timing |
| 1,500 / not run (> cap) | stage 1 O(N²logN) (s) | 0.0284 ± 0.0016 s | 0.0190 ± 0.0006 s | -0.0094 | timing |
| 1,500 / not run (> cap) | stage 2 O(N²) (s) | 0.0018 ± 0.0001 s | 0.0019 ± 0.0002 s | +0.0001 | timing |
| 1,500 / not run (> cap) | s1/s2 | 15.7× | 9.9× | -5.8000 | timing |
| 100 / 0.0001 ± 0.0000 s / 0.0002 ± 0.0000 s | cls/s2 | 10.0× | 6.4× | -3.6000 | timing |
| 100 / 0.0001 ± 0.0000 s / 0.0002 ± 0.0000 s | s1/s2 | 14.6× | 9.6× | -5.0000 | timing |
| 2,000 / not run (> cap) | stage 1 O(N²logN) (s) | 0.0398 ± 0.0016 s | 0.0329 ± 0.0008 s | -0.0069 | timing |
| 2,000 / not run (> cap) | stage 2 O(N²) (s) | 0.0033 ± 0.0003 s | 0.0031 ± 0.0002 s | -0.0002 | timing |
| 2,000 / not run (> cap) | s1/s2 | 12.0× | 10.4× | -1.6000 | timing |
| 2,500 / not run (> cap) | stage 1 O(N²logN) (s) | 0.0618 ± 0.0016 s | 0.0503 ± 0.0012 s | -0.0115 | timing |
| 2,500 / not run (> cap) | stage 2 O(N²) (s) | 0.0064 ± 0.0008 s | 0.0051 ± 0.0002 s | -0.0013 | timing |
| 2,500 / not run (> cap) | s1/s2 | 9.6× | 9.8× | +0.2000 | timing |
| 200 | classical O(N³) (s) | 0.0010 ± 0.0000 s | 0.0009 ± 0.0000 s | -0.0001 | timing |
...
| 200 | cls/s2 | 23.4× | 13.4× | -10.0000 | timing |
| 200 | s1/s2 | 14.9× | 8.4× | -6.5000 | timing |
| 3,000 / not run (> cap) | stage 1 O(N²logN) (s) | 0.0817 ± 0.0007 s | 0.0704 ± 0.0016 s | -0.0113 | timing |
| 3,000 / not run (> cap) | stage 2 O(N²) (s) | 0.0086 ± 0.0004 s | 0.0073 ± 0.0003 s | -0.0013 | timing |
| 3,000 / not run (> cap) | s1/s2 | 9.5× | 9.6× | +0.1000 | timing |
| 300 | classical O(N³) (s) | 0.0035 ± 0.0000 s | 0.0030 ± 0.0001 s | -0.0005 | timing |
| 300 | stage 1 O(N²logN) (s) | 0.0012 ± 0.0001 s | 0.0011 ± 0.0000 s | -0.0001 | timing |
| 300 | cls/s2 | 38.7× | 22.5× | -16.2000 | timing |
| 300 | s1/s2 | 13.5× | 7.9× | -5.6000 | timing |
| 500 | classical O(N³) (s) | 0.0176 ± 0.0008 s | 0.0144 ± 0.0005 s | -0.0032 | timing |
| 500 | stage 1 O(N²logN) (s) | 0.0034 ± 0.0001 s | 0.0027 ± 0.0001 s | -0.0007 | timing |
| 500 | stage 2 O(N²) (s) | 0.0003 ± 0.0001 s | 0.0003 ± 0.0000 s | +0.0000 | timing |
| 500 | cls/s2 | 63.5× | 41.3× | -22.2000 | timing |
| 500 | s1/s2 | 12.2× | 7.8× | -4.4000 | timing |
| 750 | classical O(N³) (s) | 0.0776 ± 0.0098 s | 0.0501 ± 0.0011 s | -0.0275 | timing |
| 750 | stage 1 O(N²logN) (s) | 0.0086 ± 0.0010 s | 0.0051 ± 0.0001 s | -0.0035 | timing |
| 750 | stage 2 O(N²) (s) | 0.0005 ± 0.0001 s | 0.0007 ± 0.0001 s | +0.0002 | timing |
| 750 | cls/s2 | 141.5× | 72.7× | -68.8000 | timing |
| 750 | s1/s2 | 15.6× | 7.5× | -8.1000 | timing |

### `table_3_2_memory_precision`

| Row | Column | Before | After | Δ | |
|---|---|---|---|---:|---|
| float32 | ordering vs float64 (N=2,000) | 0.001 ± 0.001 | 0.999 ± 0.002 | +0.9980 | **changed** |
| float64 | ordering vs float64 (N=2,000) | 0.001 ± 0.001 | 1.000 (exact) | +0.9990 | **changed** |

### `table_3_4_gpu_speedups`

| Row | Column | Before | After | Δ | |
|---|---|---|---|---:|---|
| Boruvka MST (device) / N=16,000, float64, matrix resident / pcvat.vat_prim_mst_c (Cython dense Prim) | CPU (s) | 0.29600 ± 0.05433 | 0.21748 ± 0.01485 | -0.0785 | **changed** |
| Boruvka MST (device) / N=16,000, float64, matrix resident / pcvat.vat_prim_mst_c (Cython dense Prim) | GPU (s) | 0.03502 ± 0.00455 | 0.04786 ± 0.00384 | +0.0128 | **changed** |
| Boruvka MST (device) / N=32,000, float64, matrix resident / pcvat.vat_prim_mst_c (Cython dense Prim) | CPU (s) | 1.00111 ± 0.08641 | 0.81405 ± 0.04405 | -0.1871 | **changed** |
| Boruvka MST (device) / N=32,000, float64, matrix resident / pcvat.vat_prim_mst_c (Cython dense Prim) | GPU (s) | 0.13304 ± 0.00757 | 0.19789 ± 0.01252 | +0.0649 | **changed** |
| Boruvka MST (device) / N=4,000, float64, matrix resident / pcvat.vat_prim_mst_c (Cython dense Prim) | CPU (s) | 0.01932 ± 0.00224 | 0.01551 ± 0.00361 | -0.0038 | **changed** |
| Boruvka MST (device) / N=8,000, float64, matrix resident / pcvat.vat_prim_mst_c (Cython dense Prim) | CPU (s) | 0.07837 ± 0.01227 | 0.05906 ± 0.01366 | -0.0193 | **changed** |
| Boruvka MST (device) / N=8,000, float64, matrix resident / pcvat.vat_prim_mst_c (Cython dense Prim) | GPU (s) | 0.00875 ± 0.00049 | 0.01146 ± 0.00182 | +0.0027 | **changed** |
| Pairwise distances / N=16,000, d=10, float32, fast (native acc) / pcvat.pairwise_distances_c (C/OpenMP) | CPU (s) | 0.22048 ± 0.01976 | 0.18365 ± 0.00861 | -0.0368 | **changed** |
| Pairwise distances / N=16,000, d=10, float32, high_precision / pcvat.pairwise_distances_c (C/OpenMP) | CPU (s) | 0.21287 ± 0.01740 | 0.18337 ± 0.01104 | -0.0295 | **changed** |
| Pairwise distances / N=16,000, d=200, float32, fast (native acc) / pcvat.pairwise_distances_c (C/OpenMP) | CPU (s) | 1.81962 ± 0.09180 | 0.65888 ± 0.02547 | -1.1607 | **changed** |
| Pairwise distances / N=16,000, d=200, float32, high_precision / pcvat.pairwise_distances_c (C/OpenMP) | CPU (s) | 1.71022 ± 0.02005 | 0.65777 ± 0.03646 | -1.0525 | **changed** |
| Pairwise distances / N=16,000, d=200, float32, high_precision / pcvat.pairwise_distances_c (C/OpenMP) | GPU (s) | 1.52900 ± 0.04712 | 1.62519 ± 0.05426 | +0.0962 | **changed** |
...
| Pairwise distances / N=16,000, d=200, float64, high_precision / pcvat.pairwise_distances_c (C/OpenMP) | CPU (s) | 1.84730 ± 0.11711 | 0.85081 ± 0.06486 | -0.9965 | **changed** |
| Pairwise distances / N=16,000, d=50, float32, fast (native acc) / pcvat.pairwise_distances_c (C/OpenMP) | CPU (s) | 0.52196 ± 0.03569 | 0.25630 ± 0.01276 | -0.2657 | **changed** |
| Pairwise distances / N=16,000, d=50, float32, high_precision / pcvat.pairwise_distances_c (C/OpenMP) | CPU (s) | 0.47682 ± 0.01414 | 0.26124 ± 0.00616 | -0.2156 | **changed** |
...
| Pairwise distances / N=16,000, d=50, float64, high_precision / pcvat.pairwise_distances_c (C/OpenMP) | CPU (s) | 0.45056 ± 0.02828 | 0.34326 ± 0.01206 | -0.1073 | **changed** |
| Pairwise distances / N=16,000, d=784, float32, fast (native acc) / pcvat.pairwise_distances_c (C/OpenMP) | CPU (s) | 7.42532 ± 0.26797 | 2.77995 ± 0.13526 | -4.6454 | **changed** |
| Pairwise distances / N=16,000, d=784, float32, fast (native acc) / pcvat.pairwise_distances_c (C/OpenMP) | GPU (s) | 1.68712 ± 0.05318 | 2.48170 ± 0.03023 | +0.7946 | **changed** |
| Pairwise distances / N=16,000, d=784, float32, high_precision / pcvat.pairwise_distances_c (C/OpenMP) | CPU (s) | 6.84382 ± 0.22974 | 2.80409 ± 0.17184 | -4.0397 | **changed** |
| Pairwise distances / N=16,000, d=784, float32, high_precision / pcvat.pairwise_distances_c (C/OpenMP) | GPU (s) | 3.99387 ± 0.04294 | 5.39620 ± 0.04986 | +1.4023 | **changed** |
...
| Pairwise distances / N=16,000, d=784, float64, high_precision / pcvat.pairwise_distances_c (C/OpenMP) | CPU (s) | 8.47066 ± 0.57599 | 4.74440 ± 0.16858 | -3.7263 | **changed** |
| Pairwise distances / N=16,000, d=784, float64, high_precision / pcvat.pairwise_distances_c (C/OpenMP) | GPU (s) | 11.14590 ± 0.07999 | 13.11990 ± 0.07710 | +1.9740 | **changed** |
| VAT front end / N=16,000, float64, UNMATCHED work / pairwise_distances_c + compute_vat_c (also reorders D) | CPU (s) | 1.50607 ± 0.08714 | 1.25109 ± 0.02691 | -0.2550 | **changed** |
| VAT front end / N=16,000, float64, order only / pairwise_distances_c + vat_prim_mst_c | CPU (s) | 0.63502 ± 0.07445 | 0.50395 ± 0.02492 | -0.1311 | **changed** |
| VAT front end / N=32,000, float64, UNMATCHED work / pairwise_distances_c + compute_vat_c (also reorders D) | GPU (s) | 0.53028 ± 0.02350 | 0.61254 ± 0.01343 | +0.0823 | **changed** |
| VAT front end / N=32,000, float64, order only / pairwise_distances_c + vat_prim_mst_c | CPU (s) | 2.67222 ± 0.13278 | 2.40970 ± 0.05357 | -0.2625 | **changed** |
| VAT front end / N=32,000, float64, order only / pairwise_distances_c + vat_prim_mst_c | GPU (s) | 0.53028 ± 0.02350 | 0.61254 ± 0.01343 | +0.0823 | **changed** |
| VAT front end / N=4,000, float64, UNMATCHED work / pairwise_distances_c + compute_vat_c (also reorders D) | CPU (s) | 0.09733 ± 0.00395 | 0.08562 ± 0.00776 | -0.0117 | **changed** |
| VAT front end / N=4,000, float64, order only / pairwise_distances_c + vat_prim_mst_c | CPU (s) | 0.04157 ± 0.00387 | 0.03678 ± 0.00461 | -0.0048 | **changed** |
| VAT front end / N=48,000, float32, 9.22 GB resident / pairwise_distances_c + vat_prim_mst_c | CPU (s) | 5.16635 | 4.11908 | -1.0473 | **changed** |
| VAT front end / N=48,000, float32, 9.22 GB resident / pairwise_distances_c + vat_prim_mst_c | GPU (s) | 1.21737 | 1.28861 | +0.0712 | **changed** |
| VAT front end / N=8,000, float64, UNMATCHED work / pairwise_distances_c + compute_vat_c (also reorders D) | CPU (s) | 0.36403 ± 0.01075 | 0.31029 ± 0.02254 | -0.0537 | **changed** |
| VAT front end / N=8,000, float64, order only / pairwise_distances_c + vat_prim_mst_c | CPU (s) | 0.14930 ± 0.01292 | 0.12761 ± 0.01310 | -0.0217 | **changed** |
| Boruvka MST (device) / N=16,000, float64, matrix resident / pcvat.vat_prim_mst_c (Cython dense Prim) | GPU speedup (CPU/GPU) | 8.45x | 4.54x | -3.9100 | timing |
| Boruvka MST (device) / N=32,000, float64, matrix resident / pcvat.vat_prim_mst_c (Cython dense Prim) | GPU speedup (CPU/GPU) | 7.52x | 4.11x | -3.4100 | timing |
| Boruvka MST (device) / N=4,000, float64, matrix resident / pcvat.vat_prim_mst_c (Cython dense Prim) | GPU (s) | 0.00321 ± 0.00020 | 0.00354 ± 0.00038 | +0.0003 | within noise |
| Boruvka MST (device) / N=4,000, float64, matrix resident / pcvat.vat_prim_mst_c (Cython dense Prim) | GPU speedup (CPU/GPU) | 6.02x | 4.38x | -1.6400 | timing |
| Boruvka MST (device) / N=8,000, float64, matrix resident / pcvat.vat_prim_mst_c (Cython dense Prim) | GPU speedup (CPU/GPU) | 8.95x | 5.15x | -3.8000 | timing |
| Fuzzy C-Means / N=200,000, k=10, d=20 / fcm.fuzzy_c_means (NumPy broadcasting -- DIFFERENT algorithm) | CPU (s) | 2.10697 ± 2.06088 | 1.92467 ± 1.89777 | -0.1823 | within noise |
| Fuzzy C-Means / N=200,000, k=10, d=20 / fcm.fuzzy_c_means (NumPy broadcasting -- DIFFERENT algorithm) | GPU (s) | 0.36445 ± 0.17667 | 0.33345 ± 0.36299 | -0.0310 | within noise |
| Fuzzy C-Means / N=200,000, k=10, d=20 / fcm.fuzzy_c_means (NumPy broadcasting -- DIFFERENT algorithm) | GPU speedup (CPU/GPU) | 5.78x | 5.77x | -0.0100 | timing |
| Fuzzy C-Means / N=200,000, k=10, d=20, MATCHED formulation / gram + 2 GEMM in NumPy/BLAS (this file) | CPU (s) | 1.04398 ± 1.02096 | 0.99717 ± 1.01518 | -0.0468 | within noise |
| Fuzzy C-Means / N=200,000, k=10, d=20, MATCHED formulation / gram + 2 GEMM in NumPy/BLAS (this file) | GPU (s) | 0.36445 ± 0.17667 | 0.33345 ± 0.36299 | -0.0310 | within noise |
| Fuzzy C-Means / N=200,000, k=10, d=20, MATCHED formulation / gram + 2 GEMM in NumPy/BLAS (this file) | GPU speedup (CPU/GPU) | 2.86x | 2.99x | +0.1300 | timing |
| Fuzzy C-Means / N=50,000, k=10, d=20 / fcm.fuzzy_c_means (NumPy broadcasting -- DIFFERENT algorithm) | CPU (s) | 0.52707 ± 0.47069 | 0.40631 ± 0.35625 | -0.1208 | within noise |
| Fuzzy C-Means / N=50,000, k=10, d=20 / fcm.fuzzy_c_means (NumPy broadcasting -- DIFFERENT algorithm) | GPU (s) | 0.10732 ± 0.10040 | 0.09651 ± 0.09645 | -0.0108 | within noise |
| Fuzzy C-Means / N=50,000, k=10, d=20 / fcm.fuzzy_c_means (NumPy broadcasting -- DIFFERENT algorithm) | GPU speedup (CPU/GPU) | 4.91x | 4.21x | -0.7000 | timing |
| Fuzzy C-Means / N=50,000, k=10, d=20, MATCHED formulation / gram + 2 GEMM in NumPy/BLAS (this file) | CPU (s) | 0.28343 ± 0.23133 | 0.22833 ± 0.23212 | -0.0551 | within noise |
| Fuzzy C-Means / N=50,000, k=10, d=20, MATCHED formulation / gram + 2 GEMM in NumPy/BLAS (this file) | GPU (s) | 0.10732 ± 0.10040 | 0.09651 ± 0.09645 | -0.0108 | within noise |
| Fuzzy C-Means / N=50,000, k=10, d=20, MATCHED formulation / gram + 2 GEMM in NumPy/BLAS (this file) | GPU speedup (CPU/GPU) | 2.64x | 2.37x | -0.2700 | timing |
| Fuzzy C-Means / N=500,000, k=10, d=20 / fcm.fuzzy_c_means (NumPy broadcasting -- DIFFERENT algorithm) | CPU (s) | 5.85392 ± 5.34906 | 5.41501 ± 4.82429 | -0.4389 | within noise |
| Fuzzy C-Means / N=500,000, k=10, d=20 / fcm.fuzzy_c_means (NumPy broadcasting -- DIFFERENT algorithm) | GPU (s) | 0.72417 ± 0.36976 | 0.80872 ± 0.41778 | +0.0846 | within noise |
| Fuzzy C-Means / N=500,000, k=10, d=20 / fcm.fuzzy_c_means (NumPy broadcasting -- DIFFERENT algorithm) | GPU speedup (CPU/GPU) | 8.08x | 6.70x | -1.3800 | timing |
| Fuzzy C-Means / N=500,000, k=10, d=20, MATCHED formulation / gram + 2 GEMM in NumPy/BLAS (this file) | CPU (s) | 3.05858 ± 3.15882 | 2.79264 ± 2.56297 | -0.2659 | within noise |
| Fuzzy C-Means / N=500,000, k=10, d=20, MATCHED formulation / gram + 2 GEMM in NumPy/BLAS (this file) | GPU (s) | 0.72417 ± 0.36976 | 0.80872 ± 0.41778 | +0.0846 | within noise |
| Fuzzy C-Means / N=500,000, k=10, d=20, MATCHED formulation / gram + 2 GEMM in NumPy/BLAS (this file) | GPU speedup (CPU/GPU) | 4.22x | 3.45x | -0.7700 | timing |
| Pairwise distances / N=16,000, d=10, float32, fast (native acc) / pcvat.pairwise_distances_c (C/OpenMP) | GPU (s) | 0.57900 ± 0.06240 | 0.54584 ± 0.04957 | -0.0332 | within noise |
| Pairwise distances / N=16,000, d=10, float32, fast (native acc) / pcvat.pairwise_distances_c (C/OpenMP) | GPU speedup (CPU/GPU) | 0.38x | 0.34x | -0.0400 | timing |
| Pairwise distances / N=16,000, d=10, float32, high_precision / pcvat.pairwise_distances_c (C/OpenMP) | GPU (s) | 0.66357 ± 0.02350 | 0.61367 ± 0.05869 | -0.0499 | within noise |
| Pairwise distances / N=16,000, d=10, float32, high_precision / pcvat.pairwise_distances_c (C/OpenMP) | GPU speedup (CPU/GPU) | 0.32x | 0.30x | -0.0200 | timing |
| Pairwise distances / N=16,000, d=10, float64, high_precision / pcvat.pairwise_distances_c (C/OpenMP) | CPU (s) | 0.27826 ± 0.01092 | 0.28500 ± 0.01531 | +0.0067 | within noise |
| Pairwise distances / N=16,000, d=10, float64, high_precision / pcvat.pairwise_distances_c (C/OpenMP) | GPU (s) | 1.00577 ± 0.07712 | 0.98285 ± 0.04709 | -0.0229 | within noise |
...
| Pairwise distances / N=16,000, d=200, float32, fast (native acc) / pcvat.pairwise_distances_c (C/OpenMP) | GPU (s) | 0.86026 ± 0.06709 | 0.86260 ± 0.03872 | +0.0023 | within noise |
| Pairwise distances / N=16,000, d=200, float32, fast (native acc) / pcvat.pairwise_distances_c (C/OpenMP) | GPU speedup (CPU/GPU) | 2.12x | 0.76x | -1.3600 | timing |
...
| Pairwise distances / N=16,000, d=200, float64, high_precision / pcvat.pairwise_distances_c (C/OpenMP) | GPU (s) | 1.60775 ± 0.12904 | 1.65933 ± 0.04905 | +0.0516 | within noise |
...
| Pairwise distances / N=16,000, d=50, float32, fast (native acc) / pcvat.pairwise_distances_c (C/OpenMP) | GPU (s) | 0.64499 ± 0.04394 | 0.64119 ± 0.02813 | -0.0038 | within noise |
| Pairwise distances / N=16,000, d=50, float32, fast (native acc) / pcvat.pairwise_distances_c (C/OpenMP) | GPU speedup (CPU/GPU) | 0.81x | 0.40x | -0.4100 | timing |
| Pairwise distances / N=16,000, d=50, float32, high_precision / pcvat.pairwise_distances_c (C/OpenMP) | GPU (s) | 0.90784 ± 0.03621 | 0.89946 ± 0.02067 | -0.0084 | within noise |
| Pairwise distances / N=16,000, d=50, float32, high_precision / pcvat.pairwise_distances_c (C/OpenMP) | GPU speedup (CPU/GPU) | 0.53x | 0.29x | -0.2400 | timing |
| Pairwise distances / N=16,000, d=50, float64, high_precision / pcvat.pairwise_distances_c (C/OpenMP) | GPU (s) | 1.14701 ± 0.06223 | 1.14775 ± 0.02017 | +0.0007 | within noise |
...
| Pairwise distances / N=16,000, d=784, float32, fast (native acc) / pcvat.pairwise_distances_c (C/OpenMP) | GPU speedup (CPU/GPU) | 4.40x | 1.12x | -3.2800 | timing |
| Pairwise distances / N=16,000, d=784, float32, high_precision / pcvat.pairwise_distances_c (C/OpenMP) | GPU speedup (CPU/GPU) | 1.71x | 0.52x | -1.1900 | timing |
| Pairwise distances / N=16,000, d=784, float64, high_precision / pcvat.pairwise_distances_c (C/OpenMP) | GPU speedup (CPU/GPU) | 0.76x | 0.36x | -0.4000 | timing |
...
| VAT front end / N=16,000, float64, UNMATCHED work / pairwise_distances_c + compute_vat_c (also reorders D) | GPU (s) | 0.15583 ± 0.01252 | 0.16483 ± 0.00904 | +0.0090 | within noise |
| VAT front end / N=16,000, float64, UNMATCHED work / pairwise_distances_c + compute_vat_c (also reorders D) | GPU speedup (CPU/GPU) | 9.66x | 7.59x | -2.0700 | timing |
| VAT front end / N=16,000, float64, order only / pairwise_distances_c + vat_prim_mst_c | GPU (s) | 0.15583 ± 0.01252 | 0.16483 ± 0.00904 | +0.0090 | within noise |
| VAT front end / N=16,000, float64, order only / pairwise_distances_c + vat_prim_mst_c | GPU speedup (CPU/GPU) | 4.08x | 3.06x | -1.0200 | timing |
| VAT front end / N=32,000, float64, UNMATCHED work / pairwise_distances_c + compute_vat_c (also reorders D) | CPU (s) | 6.98682 ± 1.22449 | 5.95395 ± 0.48169 | -1.0329 | within noise |
| VAT front end / N=32,000, float64, UNMATCHED work / pairwise_distances_c + compute_vat_c (also reorders D) | GPU speedup (CPU/GPU) | 13.18x | 9.72x | -3.4600 | timing |
| VAT front end / N=32,000, float64, order only / pairwise_distances_c + vat_prim_mst_c | GPU speedup (CPU/GPU) | 5.04x | 3.93x | -1.1100 | timing |
| VAT front end / N=4,000, float64, UNMATCHED work / pairwise_distances_c + compute_vat_c (also reorders D) | GPU (s) | 0.01661 ± 0.00048 | 0.01547 ± 0.00366 | -0.0011 | within noise |
| VAT front end / N=4,000, float64, UNMATCHED work / pairwise_distances_c + compute_vat_c (also reorders D) | GPU speedup (CPU/GPU) | 5.86x | 5.54x | -0.3200 | timing |
| VAT front end / N=4,000, float64, order only / pairwise_distances_c + vat_prim_mst_c | GPU (s) | 0.01661 ± 0.00048 | 0.01547 ± 0.00366 | -0.0011 | within noise |
| VAT front end / N=4,000, float64, order only / pairwise_distances_c + vat_prim_mst_c | GPU speedup (CPU/GPU) | 2.50x | 2.38x | -0.1200 | timing |
| VAT front end / N=48,000, float32, 9.22 GB resident / pairwise_distances_c + vat_prim_mst_c | GPU speedup (CPU/GPU) | 4.24x | 3.20x | -1.0400 | timing |
| VAT front end / N=8,000, float64, UNMATCHED work / pairwise_distances_c + compute_vat_c (also reorders D) | GPU (s) | 0.04268 ± 0.00529 | 0.04194 ± 0.00435 | -0.0007 | within noise |
| VAT front end / N=8,000, float64, UNMATCHED work / pairwise_distances_c + compute_vat_c (also reorders D) | GPU speedup (CPU/GPU) | 8.53x | 7.40x | -1.1300 | timing |
| VAT front end / N=8,000, float64, order only / pairwise_distances_c + vat_prim_mst_c | GPU (s) | 0.04268 ± 0.00529 | 0.04194 ± 0.00435 | -0.0007 | within noise |
| VAT front end / N=8,000, float64, order only / pairwise_distances_c + vat_prim_mst_c | GPU speedup (CPU/GPU) | 3.50x | 3.04x | -0.4600 | timing |

### `table_3_7_g2_downstream`

Rows only in `goal-8h-2026-08-11-fullsuite`: `Crop (N=24000, k_true=24) / 0.029 ± 0.009 / 0.064 (k=671, cov=0.62)`, `FordA (N=4921, k_true=2) / 0.000 ± 0.000 / 0.002 (k=18, cov=0.59)`
...
| Row | Column | Before | After | Δ | |
|---|---|---|---|---:|---|
| ECG5000 (DTW, N=5000) / no / 20.9% | Timing | 631s matrix + 0.3s reorder | 593s matrix + 0.2s reorder | -38.0000 | **changed** |

### `table_4_1`

| Row | Column | Before | After | Δ | |
|---|---|---|---|---:|---|
| Bike Sharing (regression) | MoG accuracy / R2 | R2=0.939 ± 0.004 | R2=0.960 ± 0.003 | +0.0210 | **changed** |
| Bike Sharing (regression) | MoG train time | 0.82 ± 0.03 s | 0.17 ± 0.01 s | -0.6500 | timing |
| Concrete (regression) | MoG train time | 0.41 ± 0.02 s | 0.06 ± 0.00 s | -0.3500 | timing |
| Concrete (regression) | MoG accuracy / R2 | R2=0.795 ± 0.025 | R2=0.808 ± 0.030 | +0.0130 | within noise |
| Concrete (regression, full 2nd order) | MoG train time | 0.42 ± 0.01 s | 0.07 ± 0.01 s | -0.3500 | timing |
| Concrete (regression, full 2nd order) | MoG accuracy / R2 | R2=0.852 ± 0.030 | R2=0.867 ± 0.031 | +0.0150 | within noise |
| PhiUSIIL (classification) | MoG train time | 0.28 ± 0.03 s | 0.07 ± 0.00 s | -0.2100 | timing |
| RT-IOT2022 (12-class) | MoG train time | 37.42 ± 0.64 s | 2.88 ± 0.10 s | -34.5400 | timing |
...
| Row | Column | Before | After | Δ | |
|---|---|---|---|---:|---|
| Complement rule (this work) | Detection − false alarm | +0.394 | +0.367 | -0.0270 | **changed** |
| Isolation Forest | Detection − false alarm | +0.537 | +0.534 | -0.0030 | **changed** |
| One-class SVM | Detection − false alarm | +0.408 | +0.416 | +0.0080 | **changed** |
| Complement rule (this work) | Detection rate | 0.839 ± 0.253 | 0.798 ± 0.273 | -0.0410 | within noise |
| Complement rule (this work) | False-alarm rate | 0.445 ± 0.091 | 0.431 ± 0.074 | -0.0140 | within noise |
| Isolation Forest | Detection rate | 0.974 ± 0.117 | 0.962 ± 0.145 | -0.0120 | within noise |
| Isolation Forest | False-alarm rate | 0.437 ± 0.056 | 0.429 ± 0.070 | -0.0080 | within noise |
| One-class SVM | Detection rate | 0.847 ± 0.236 | 0.848 ± 0.231 | +0.0010 | within noise |
| One-class SVM | False-alarm rate | 0.439 ± 0.057 | 0.432 ± 0.065 | -0.0070 | within noise |

### `table_4_4b_theta_sweep`

| Row | Column | Before | After | Δ | |
|---|---|---|---|---:|---|
| 0.500 | detection rate | 0.838 | 0.959 | +0.1210 | **changed** |
| 0.500 | false-alarm rate | 0.719 | 0.672 | -0.0470 | **changed** |
| 0.500 | detection − false alarm | +0.119 | +0.287 | +0.1680 | **changed** |
| 0.600 | detection rate | 0.815 | 0.945 | +0.1300 | **changed** |
| 0.600 | false-alarm rate | 0.664 | 0.609 | -0.0550 | **changed** |
| 0.600 | detection − false alarm | +0.151 | +0.336 | +0.1850 | **changed** |
| 0.700 | detection rate | 0.762 | 0.935 | +0.1730 | **changed** |
| 0.700 | false-alarm rate | 0.616 | 0.569 | -0.0470 | **changed** |
| 0.700 | detection − false alarm | +0.146 | +0.366 | +0.2200 | **changed** |
| 0.800 | detection rate | 0.700 | 0.908 | +0.2080 | **changed** |
| 0.800 | false-alarm rate | 0.546 | 0.515 | -0.0310 | **changed** |
| 0.800 | detection − false alarm | +0.154 | +0.393 | +0.2390 | **changed** |
| 0.900 | detection rate | 0.625 | 0.836 | +0.2110 | **changed** |
| 0.900 | false-alarm rate | 0.475 | 0.465 | -0.0100 | **changed** |
| 0.900 | detection − false alarm | +0.150 | +0.370 | +0.2200 | **changed** |
| 0.990 | detection rate | 0.491 | 0.777 | +0.2860 | **changed** |
| 0.990 | false-alarm rate | 0.362 | 0.431 | +0.0690 | **changed** |
| 0.990 | detection − false alarm | +0.129 | +0.346 | +0.2170 | **changed** |

### `table_4_8_mf_dedup`

Rows only in `bumped-0764bc5-2026-08-22`: `Diabetes / regression / 40.6`
...
Rows only in `bumped-0764bc5-2026-08-22`: `Diabetes / regression / 0.1`, `Diabetes / regression / 0.3`, `Diabetes / regression / 1`, `Diabetes / regression / 10`, `Diabetes / regression / 100`, `Diabetes / regression / 15`, `Diabetes / regression / 2`, `Diabetes / regression / 20`, `Diabetes / regression / 3`, `Diabetes / regression / 30`, `Diabetes / regression / 5`, `Diabetes / regression / 50`, `Diabetes / regression / 7`, `Diabetes / regression / 70`
...
| Row | Column | Before | After | Δ | |
|---|---|---|---|---:|---|
| 1 | bhattacharyya (acc / fit s) | 0.4267 / 0.18 | 0.9967 / 0.06 | +0.5700 | **changed** |
| 1 | composite (acc / fit s) | 0.4267 / 0.25 | 0.9967 / 0.06 | +0.5700 | **changed** |
| 10 | wasserstein (acc / fit s) | 0.9997 / 0.75 | 0.9995 / 0.09 | -0.0002 | **changed** |
| 10 | bhattacharyya (acc / fit s) | 0.9701 / 0.85 | 0.9999 / 0.10 | +0.0298 | **changed** |
| 10 | composite (acc / fit s) | 0.9983 / 0.91 | 0.9998 / 0.13 | +0.0015 | **changed** |
| 15 | wasserstein (acc / fit s) | 0.9957 / 0.62 | 0.9929 / 0.17 | -0.0028 | **changed** |
| 15 | bhattacharyya (acc / fit s) | 0.9788 / 0.70 | 0.9999 / 0.15 | +0.0211 | **changed** |
| 2 | bhattacharyya (acc / fit s) | 0.4527 / 0.18 | 0.9999 / 0.06 | +0.5472 | **changed** |
| 2 | composite (acc / fit s) | 0.9967 / 0.58 | 0.9999 / 0.07 | +0.0032 | **changed** |
| 20 | wasserstein (acc / fit s) | 0.9984 / 0.71 | 0.9980 / 0.21 | -0.0004 | **changed** |
| 20 | bhattacharyya (acc / fit s) | 0.9796 / 0.74 | 0.9995 / 0.22 | +0.0199 | **changed** |
| 20 | composite (acc / fit s) | 0.9991 / 1.15 | 0.9997 / 0.22 | +0.0006 | **changed** |
| 3 | bhattacharyya (acc / fit s) | 0.8447 / 0.61 | 0.9999 / 0.06 | +0.1552 | **changed** |
| 3 | composite (acc / fit s) | 0.9967 / 0.28 | 0.9999 / 0.07 | +0.0032 | **changed** |
| 4 | bhattacharyya (acc / fit s) | 0.9160 / 0.31 | 0.9999 / 0.06 | +0.0839 | **changed** |
| 4 | composite (acc / fit s) | 0.9966 / 0.34 | 0.9999 / 0.07 | +0.0033 | **changed** |
| 5 | wasserstein (acc / fit s) | 0.9965 / 0.41 | 0.9966 / 0.07 | +0.0001 | **changed** |
| 5 | bhattacharyya (acc / fit s) | 0.9467 / 0.33 | 0.9999 / 0.06 | +0.0532 | **changed** |
| 5 | composite (acc / fit s) | 0.9966 / 0.37 | 0.9999 / 0.08 | +0.0033 | **changed** |
| 7 | bhattacharyya (acc / fit s) | 0.9632 / 0.40 | 0.9999 / 0.07 | +0.0367 | **changed** |
| 7 | composite (acc / fit s) | 0.9967 / 0.44 | 0.9998 / 0.10 | +0.0031 | **changed** |
| 1 | wasserstein (acc / fit s) | 0.9967 / 0.47 | 0.9967 / 0.06 | +0.0000 | within noise |
| 15 | composite (acc / fit s) | 0.9999 / 0.63 | 0.9999 / 0.21 | +0.0000 | within noise |
| 2 | wasserstein (acc / fit s) | 0.9967 / 0.38 | 0.9967 / 0.06 | +0.0000 | within noise |
| 3 | wasserstein (acc / fit s) | 0.9967 / 0.36 | 0.9967 / 0.06 | +0.0000 | within noise |
| 4 | wasserstein (acc / fit s) | 0.9967 / 0.31 | 0.9967 / 0.07 | +0.0000 | within noise |
| 7 | wasserstein (acc / fit s) | 0.9998 / 0.44 | 0.9998 / 0.07 | +0.0000 | within noise |
...
| flat MoG-TSK 0th / log+standardized / refined | R² | 0.720 ± 0.037 | 0.747 ± 0.031 | +0.0270 | within noise |
| flat MoG-TSK 0th / log+standardized / refined | RMSE | 8.63 ± 0.40 | 8.21 ± 0.45 | -0.4200 | within noise |
...
| flat MoG-TSK 1st / log+standardized / refined | R² | 0.834 ± 0.045 | 0.835 ± 0.039 | +0.0010 | within noise |
| flat MoG-TSK 1st / log+standardized / refined | RMSE | 6.59 ± 0.65 | 6.57 ± 0.55 | -0.0200 | within noise |
...
| flat MoG-TSK 2nd / log+standardized / refined | R² | 0.862 ± 0.033 | 0.852 ± 0.021 | -0.0100 | within noise |
| flat MoG-TSK 2nd / log+standardized / refined | RMSE | 6.00 ± 0.52 | 6.27 ± 0.40 | +0.2700 | within noise |
