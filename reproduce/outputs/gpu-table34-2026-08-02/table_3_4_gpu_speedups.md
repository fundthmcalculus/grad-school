...
| Boruvka MST (device) | N=8,000, float64, matrix resident | 1.0× (worst) | 7.6× | order 1.000 (bit-identical) | estimate (10 seeds) |
| VAT front end | N=8,000, float64, order only | 1.0× (worst) | 2.8× | order 1.000 (bit-identical) | estimate (10 seeds) |
| VAT front end | N=8,000, float64, UNMATCHED work | 1.0× (worst) | 7.1× | order 1.000 (bit-identical) | estimate (10 seeds) |
| Boruvka MST (device) | N=16,000, float64, matrix resident | 1.0× (worst) | 7.7× | order 1.000 (bit-identical) | estimate (10 seeds) |
| VAT front end | N=16,000, float64, order only | 1.0× (worst) | 3.9× | order 1.000 (bit-identical) | estimate (10 seeds) |
| VAT front end | N=16,000, float64, UNMATCHED work | 1.0× (worst) | 9.5× | order 1.000 (bit-identical) | estimate (10 seeds) |
| Boruvka MST (device) | N=32,000, float64, matrix resident | 1.0× (worst) | 6.3× | order 1.000 (bit-identical) | estimate (10 seeds) |
| VAT front end | N=32,000, float64, order only | 1.0× (worst) | 4.9× | order 1.000 (bit-identical) | estimate (10 seeds) |
| VAT front end | N=32,000, float64, UNMATCHED work | 1.0× (worst) | 11.8× | order 1.000 (bit-identical) | estimate (10 seeds) |
| Fuzzy C-Means | N=50,000, k=10, d=20 | 1.0× (worst) | 14.4× | labels 1.000 ± 0.001; max abs Δcentre 4.9e-05 | estimate (10 seeds) |
| Fuzzy C-Means | N=50,000, k=10, d=20, MATCHED formulation | 1.0× (worst) | 1.3× | labels 1.000; max abs Δcentre 1.6e-13 | estimate (10 seeds) |
| Fuzzy C-Means | N=200,000, k=10, d=20 | 1.0× (worst) | 24.1× | labels 1.000; max abs Δcentre 4.8e-06 | estimate (10 seeds) |
| Fuzzy C-Means | N=200,000, k=10, d=20, MATCHED formulation | 1.0× (worst) | 2.1× | labels 1.000; max abs Δcentre 3.2e-13 | estimate (10 seeds) |
| Fuzzy C-Means | N=500,000, k=10, d=20 | 1.0× (worst) | 41.0× | labels 1.000; max abs Δcentre 9.8e-06 | estimate (10 seeds) |
...
| Pairwise distances | N=16,000, d=10, float32, high_precision | 2.9× | 1.0× (worst) | max abs Δ = 0.0e+00 | estimate (10 seeds) |
| Pairwise distances | N=16,000, d=10, float32, fast (native acc) | 2.8× | 1.0× (worst) | max abs Δ = 3.8e-06 | estimate (10 seeds) |
...
| Pairwise distances | N=16,000, d=784, float32, high_precision | 1.0× (worst) | 1.5× | max abs Δ = 0.0e+00 | estimate (10 seeds) |
