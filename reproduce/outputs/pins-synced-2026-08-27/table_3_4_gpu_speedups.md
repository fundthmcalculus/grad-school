...
|---|---|---|---|---|---|
| Boruvka MST (device) | N=4,000, float64, matrix resident | 1.0× (worst) | 4.9× | order 1.000 (bit-identical) | estimate (3 seeds) |
| VAT front end | N=4,000, float64, order only | 1.0× (worst) | 2.6× | order 1.000 (bit-identical) | estimate (3 seeds) |
| VAT front end | N=4,000, float64, UNMATCHED work | 1.0× (worst) | 5.8× | order 1.000 (bit-identical) | estimate (3 seeds) |
| Boruvka MST (device) | N=8,000, float64, matrix resident | 1.0× (worst) | 5.9× | order 1.000 (bit-identical) | estimate (3 seeds) |
| VAT front end | N=8,000, float64, order only | 1.0× (worst) | 2.7× | order 1.000 (bit-identical) | estimate (3 seeds) |
| VAT front end | N=8,000, float64, UNMATCHED work | 1.0× (worst) | 6.5× | order 1.000 (bit-identical) | estimate (3 seeds) |
| Boruvka MST (device) | N=16,000, float64, matrix resident | 1.0× (worst) | 6.7× | order 1.000 (bit-identical) | estimate (3 seeds) |
| VAT front end | N=16,000, float64, order only | 1.0× (worst) | 3.5× | order 1.000 (bit-identical) | estimate (3 seeds) |
| VAT front end | N=16,000, float64, UNMATCHED work | 1.0× (worst) | 8.6× | order 1.000 (bit-identical) | estimate (3 seeds) |
| Boruvka MST (device) | N=32,000, float64, matrix resident | 1.0× (worst) | 6.0× | order 1.000 (bit-identical) | estimate (3 seeds) |
| VAT front end | N=32,000, float64, order only | 1.0× (worst) | 4.8× | order 1.000 (bit-identical) | estimate (3 seeds) |
| VAT front end | N=32,000, float64, UNMATCHED work | 1.0× (worst) | 14.3× | order 1.000 (bit-identical) | estimate (3 seeds) |
| Fuzzy C-Means | N=50,000, k=10, d=20 | 1.0× (worst) | 7.8× | labels 1.000; max abs Δcentre 7.0e-06 | estimate (3 seeds) |
| Fuzzy C-Means | N=50,000, k=10, d=20, MATCHED formulation | 1.0× (worst) | 4.1× | labels 1.000; max abs Δcentre 1.4e-13 | estimate (3 seeds) |
| Fuzzy C-Means | N=200,000, k=10, d=20 | 1.0× (worst) | 5.4× | labels 1.000; max abs Δcentre 4.8e-06 | estimate (3 seeds) |
| Fuzzy C-Means | N=200,000, k=10, d=20, MATCHED formulation | 1.0× (worst) | 2.7× | labels 1.000; max abs Δcentre 2.5e-13 | estimate (3 seeds) |
| Fuzzy C-Means | N=500,000, k=10, d=20 | 1.0× (worst) | 8.9× | labels 1.000; max abs Δcentre 7.7e-07 | estimate (3 seeds) |
| Fuzzy C-Means | N=500,000, k=10, d=20, MATCHED formulation | 1.0× (worst) | 4.4× | labels 1.000; max abs Δcentre 4.4e-13 | estimate (3 seeds) |
| Pairwise distances | N=16,000, d=10, float64, high_precision | 3.3× | 1.0× (worst) | max abs Δ = 7.1e-15 | estimate (3 seeds) |
| Pairwise distances | N=16,000, d=50, float64, high_precision | 3.4× | 1.0× (worst) | max abs Δ = 2.8e-14 | estimate (3 seeds) |
| Pairwise distances | N=16,000, d=200, float64, high_precision | 1.7× | 1.0× (worst) | max abs Δ = 7.1e-14 | estimate (3 seeds) |
| Pairwise distances | N=16,000, d=784, float64, high_precision | 2.2× | 1.0× (worst) | max abs Δ = 2.8e-13 | estimate (3 seeds) |
| Pairwise distances | N=16,000, d=10, float32, high_precision | 2.9× | 1.0× (worst) | max abs Δ = 0.0e+00 | estimate (3 seeds) |
| Pairwise distances | N=16,000, d=10, float32, fast (native acc) | 2.7× | 1.0× (worst) | max abs Δ = 3.8e-06 | estimate (3 seeds) |
| Pairwise distances | N=16,000, d=50, float32, high_precision | 3.1× | 1.0× (worst) | max abs Δ = 1.9e-06 | estimate (3 seeds) |
| Pairwise distances | N=16,000, d=50, float32, fast (native acc) | 2.3× | 1.0× (worst) | max abs Δ = 1.1e-05 | estimate (3 seeds) |
| Pairwise distances | N=16,000, d=200, float32, high_precision | 2.4× | 1.0× (worst) | max abs Δ = 3.8e-06 | estimate (3 seeds) |
| Pairwise distances | N=16,000, d=200, float32, fast (native acc) | 1.2× | 1.0× (worst) | max abs Δ = 3.8e-05 | estimate (3 seeds) |
| Pairwise distances | N=16,000, d=784, float32, high_precision | 1.7× | 1.0× (worst) | max abs Δ = 7.6e-06 | estimate (3 seeds) |
| Pairwise distances | N=16,000, d=784, float32, fast (native acc) | 1.0× (worst) | 1.2× | max abs Δ = 1.4e-04 | estimate (3 seeds) |
| VAT front end | N=48,000, float32, 9.22 GB resident | 1.0× (worst) | 3.1× | order 0.99992; Prim total CPU 42023.180315 vs GPU 42023.180315 (rel 0.00e+00) | demonstration (1 shot) |

> **Device.** NVIDIA GeForce RTX 4080 Laptop GPU, 12282 MiB, 610.74; compute capability 89; VRAM free 11.6/12.9 GB at start; CuPy 14.1.1; CUDA runtime 12.9. **The Markdown arms are normalized against the slower arm in each row**: the loser is the 1.0x baseline and the winner reads as 'this many times faster', so a row where **the GPU is the 1.0x baseline is a row the GPU loses**. Absolute seconds and their per-seed spreads are in the companion CSV; ratios survive a change of machine and seconds do not. 
>
