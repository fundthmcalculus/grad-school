...
|---|---|---|---|---|---|
| Boruvka MST (device) | N=4,000, float64, matrix resident | 1.0× (worst) | 4.2× | order 1.000 (bit-identical) | estimate (10 seeds) |
| VAT front end | N=4,000, float64, order only | 1.0× (worst) | 2.2× | order 1.000 (bit-identical) | estimate (10 seeds) |
| VAT front end | N=4,000, float64, UNMATCHED work | 1.0× (worst) | 5.2× | order 1.000 (bit-identical) | estimate (10 seeds) |
| Boruvka MST (device) | N=8,000, float64, matrix resident | 1.0× (worst) | 6.7× | order 1.000 (bit-identical) | estimate (10 seeds) |
| VAT front end | N=8,000, float64, order only | 1.0× (worst) | 3.2× | order 1.000 (bit-identical) | estimate (10 seeds) |
| VAT front end | N=8,000, float64, UNMATCHED work | 1.0× (worst) | 7.8× | order 1.000 (bit-identical) | estimate (10 seeds) |
| Boruvka MST (device) | N=16,000, float64, matrix resident | 1.0× (worst) | 6.6× | order 1.000 (bit-identical) | estimate (10 seeds) |
| VAT front end | N=16,000, float64, order only | 1.0× (worst) | 3.8× | order 1.000 (bit-identical) | estimate (10 seeds) |
| VAT front end | N=16,000, float64, UNMATCHED work | 1.0× (worst) | 9.2× | order 1.000 (bit-identical) | estimate (10 seeds) |
| Boruvka MST (device) | N=32,000, float64, matrix resident | 1.0× (worst) | 6.1× | order 1.000 (bit-identical) | estimate (10 seeds) |
| VAT front end | N=32,000, float64, order only | 1.0× (worst) | 4.8× | order 1.000 (bit-identical) | estimate (10 seeds) |
...
| Fuzzy C-Means | N=200,000, k=10, d=20 | 1.0× (worst) | 6.3× | labels 1.000; max abs Δcentre 4.8e-06 | estimate (10 seeds) |
...
| Fuzzy C-Means | N=500,000, k=10, d=20 | 1.0× (worst) | 7.4× | labels 1.000; max abs Δcentre 9.8e-06 | estimate (10 seeds) |
...
| Pairwise distances | N=16,000, d=200, float64, high_precision | 1.6× | 1.0× (worst) | max abs Δ = 7.1e-14 | estimate (10 seeds) |
| Pairwise distances | N=16,000, d=784, float64, high_precision | 2.3× | 1.0× (worst) | max abs Δ = 2.8e-13 | estimate (10 seeds) |
...
| Pairwise distances | N=16,000, d=200, float32, high_precision | 2.2× | 1.0× (worst) | max abs Δ = 3.8e-06 | estimate (10 seeds) |
| Pairwise distances | N=16,000, d=200, float32, fast (native acc) | 1.2× | 1.0× (worst) | max abs Δ = 3.8e-05 | estimate (10 seeds) |
| Pairwise distances | N=16,000, d=784, float32, high_precision | 1.5× | 1.0× (worst) | max abs Δ = 7.6e-06 | estimate (10 seeds) |
| Pairwise distances | N=16,000, d=784, float32, fast (native acc) | 1.0× (worst) | 1.9× | max abs Δ = 1.4e-04 | estimate (10 seeds) |
