...
| `experiments/fis-tsp-strategy/`                                      | FIS-vs-TSP strategy work; `test_invariants.py` reads `.tsp` instances from `ClusteringExperiments/tsplib/` (fetched by `download.py`, not vendored) |
