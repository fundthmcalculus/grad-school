...
This paper develops an idea due to K.\ Cohen: that fitting a fuzzy inference
system should be posed as a principle of least action rather than as least
squares, and that the resulting stationarity conditions should be strong enough
to certify optimality rather than merely to terminate an optimizer. The
...
The least-action formulation of TSK inference is due to Dr.\ Kelly Cohen, whose
handwritten derivation this work develops; the orthogonality question of
\S\ref{sec:orthogonality} and the classifier framing of \S\ref{sec:classifier}
arose in discussion with him.
