...
def main():
    ...
    r2_3opt, rmse_3opt = report_regression_performance(
        start_time, y_test, y_test_pred_third_order_opt, n_order="2-full optimized"
    )
    plot_tsk_order_comparison(
        [r2_0opt, r2_1opt, r2_2opt, r2_3opt],
        [rmse_0opt, rmse_1opt, rmse_2opt, rmse_3opt],
        y_test,
        [
        ...
        ["0 Optimized", "1 Optimized", "2 Optimized", "3 Optimized"],
    )
