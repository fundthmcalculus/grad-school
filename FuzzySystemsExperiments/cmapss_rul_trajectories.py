...
from cmapss_rul import (
    load_h5, to_frame, feature_columns, H5_PATH,
    fit_raw_condition_correction, apply_raw_condition_correction,
    aggregate_whole_cycle, aggregate_raw_memory,
    unit_physical_caps, apply_rul_shape,
)
from tribblefis.gaussian_regressor import TribbleRegressor

PIPELINES = {
    "A3_raw_memory_cc/B3/C3_physical": dict(
        aggregate=aggregate_raw_memory, feature_set="B3",
        tribble_kwargs=dict(
    ...
    "A1_whole_cycle_cc/B1/C3_physical": dict(
        aggregate=aggregate_whole_cycle, feature_set="B1",
        tribble_kwargs=dict(
