...
The 18-real-sensor pipeline (see `cmapss_ds02_rul.py`) pooled over every usable N-CMAPSS file -- each contributing its own official train/test engines -- and scored two ways. Regenerated by `cmapss_all_datasets.py`.
...
| `raw_memory` | 18 real | 15.80 | 22.69 | 21,793 | 5.2 |
