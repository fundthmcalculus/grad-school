...
def main():
    ...
    print("\n" + "=" * 70)
    print("REAL-DATA-ONLY MIMO-MEMORY PIPELINE (DE-tuned)")
    print("=" * 70)
    print(f"config: {best}")
    ...
    print("\ncompare: best_full_de_minmax (physical + 2 virtual) per-sample RMSE 15.21")
    print("         honest_full_tuned (physical, whole-cycle) per-sample RMSE 15.95")
