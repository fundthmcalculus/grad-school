...
5. ~~**Quantify the correction-rule pass** (Ch 4 §4.3.1).~~ ✅ **Done, at reduced scope (2026-08-05, CHECKLIST C4).** Measured on Glass, ten paired seeds, not the originally scoped RT-IOT2022 confusion matrices — RT-IOT2022 is still not in the repository. The gated cascade gains +0.031 ± 0.027 accuracy over the flat base; collapsing it into one deployable FIS keeps +0.014 ± 0.061 of that. Also produced Table 4.8, a membership-function-deduplication tolerance sweep across six datasets, and filed [`tribble-fis` #85](https://github.com/fundthmcalculus/tribble-fis/issues/85) upstream.
