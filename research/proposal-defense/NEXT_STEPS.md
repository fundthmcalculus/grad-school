...
> `reproduce/compare_runs.py:331`, which prints "control clocks or thermals (see G4 in `NEXT_STEPS.md`)" at runtime, so the citation was dangling. It is restored **verbatim**: nothing
