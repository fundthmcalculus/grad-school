...
|---|---|---|---|
| 1. Scalable structure discovery (mergeVAT, VAT/iVAT, VAT↔TSP) | `tribble-cluster` | **Done** (NAFIPS papers 1 & 2) | Part II, Ch 3 |
...
- **Ch 3 — Scalable Structure Discovery: mergeVAT** (`03-scalable-structure-discovery-mergevat.md`): accelerated exact VAT/iVAT, in-place memory, GPU Borůvka, divide-&-conquer with principled stitch, arbitrary/non-metric dissimilarity; VAT↔TSP hot-start.
...
- **Fixes to make before submission:** retire the "priority-queue MST speedup" O-notation framing for dense graphs; drop the ungrounded "pVAT six-orders-of-magnitude" web claim; fix Zhang-2023 attribution; re-verify DOIs; re-run timings on thermally stable hardware with error bars.
