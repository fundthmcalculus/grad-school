...
| **Q2 — 2027 Q2** | Membership generation | G1 | One-pass MF (MEMBERSHIP_ROADMAP phases 1–4); Ch 5 paper → NAFIPS 2026 Banff |
...
- Papers pipeline: Ch 3 journal (Q1) → Ch 5 → NAFIPS 2026 Banff (Q2) → Ch 6 (Q4) → capstone/journal (Q5).
...
- Confirm which conferences drive the paper schedule. **Known anchor: NAFIPS 2026, Banff, Alberta** — the target venue for the Ch 5 (topological membership) and Ch 4 (MoG) submissions; back-plan the Q2–Q3 2027 work against its abstract/paper deadlines once announced.
