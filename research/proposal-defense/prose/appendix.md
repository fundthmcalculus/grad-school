...
| RT-IOT2022, leave-one-class-out | {{dataset.rt_iot2022.shape_full}} | **measured, 2026-08-12** (Table 4.7b, five seeds): the complement rule loses to Isolation Forest at this scale (+0.394 vs +0.537 Youden's $J$) | large / scale — the missing partner, now filled, unfavorably |
